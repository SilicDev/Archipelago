...
def connect_regions(world: World) -> None:
    ...
    connect(world, LocationNames.ruins_boss_2_region, LocationNames.ruins_post_boss_2_region, None)
    ...
    connect(world, LocationNames.crystalline_grotto_right_save_region, LocationNames.crystalline_grotto_center_region, upgraded_ruby_rule)
    ...
    connect(world, LocationNames.crystalline_grotto_bottom_region, LocationNames.crystalline_grotto_right_save_region, chika_block_rule | gloves_rule, True)

    connect(world, LocationNames.crystalline_grotto_bottom_region, LocationNames.crystalline_grotto_boss_region, dia_rule | gloves_rule, True)
    connect(world, LocationNames.crystalline_grotto_boss_region, LocationNames.crystalline_grotto_bottom_region, None, True)
